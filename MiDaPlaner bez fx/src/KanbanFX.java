...
public class KanbanFX extends Application {
    ...
    void showLogin(Stage stage) {
        ...
        root.getChildren().addAll(new Label("Kanban Login"), usernameField, passwordField, loginBtn, regBtn);
        stage.setScene(new Scene(root, 300, 250));
        stage.show();
    }

    void showMainMenu(Stage stage) {
        stage.setTitle("Kanban - " + currentUser.username);
        VBox root = new VBox(10);
